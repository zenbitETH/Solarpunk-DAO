...
//     const balance = await NFTContract.balanceOf(myAddress, tokenId);
...
//   .addParam("amount", "The nft amount we want to send to DAO")
//   .addParam("data", "The bytes data sent with transfer")
//   .setAction(async (args, hre) => {
//     const NFTContract = await hre.ethers.getContractAt(
//       "CryptoDevsNFT",
//       args.nftContract
...
//     const txn = await NFTContract["safeTransferFrom(address,address,uint256,uint256,bytes)"](
//       myAddress,
//       args.daoContract,
//       args.tokenId,
//       args.amount,
